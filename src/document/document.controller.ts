import { BadRequestException, Controller, Get, Param, Post, Res, UploadedFiles, UseGuards, UseInterceptors } from "@nestjs/common";
...
export class DocumentController {
    ...
    async uploadStructuredFiles(@UploadedFiles() files: any , @GetUser() User: any){
        if(!files) {
